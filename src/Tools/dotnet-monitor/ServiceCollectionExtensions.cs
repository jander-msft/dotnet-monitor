...
namespace Microsoft.Diagnostics.Tools.Monitor
{
    internal static class ServiceCollectionExtensions
    {
            ...
            where TOptions : class
        {
            ...
            services.AddSingleton(sp => new EgressProviderConfiguration<TOptions>(sp.GetRequiredService<IConfiguration>(), name));
            services.TryAddSingletonEnumerableForwarder<IEgressProviderConfiguration, EgressProviderConfiguration<TOptions>>();
            services.TryAddSingletonEnumerableForwarder<IEgressProviderConfiguration<TOptions>, EgressProviderConfiguration<TOptions>>();

            // Add options services for configuring the options type
            services.AddSingleton<IConfigureOptions<TOptions>, EgressConfigureNamedOptions<TOptions>>();
            ...
            // Add mapping between provider name and options type
            services.TryAddSingletonEnumerable<IEgressProviderDescriptor, EgressProviderDescriptor<TOptions>>(_ => new EgressProviderDescriptor<TOptions>(name));
