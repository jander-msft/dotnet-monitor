...
namespace Microsoft.Diagnostics.Monitoring.UnitTests.HttpApi
{
    internal sealed class ApiClient
    {
        ...
        {
            using HttpRequestMessage request = new(HttpMethod.Get, $"/trace/{processKey}?profile={profile:G}&durationSeconds={durationSeconds:D}&metricIntervalSeconds={metricsIntervalSeconds:D}");
            request.Headers.Add(HeaderNames.Accept, ContentTypes.ApplicationOctetStream);
